...
export default function TitleAnimation({data={}}) {
    const [ref, isVisible] = useOnScreen({
        threshold: 0.1 // Activar cuando el 10% del elemento sea visible
    });

    // 2. Definimos el valor del retraso inicial
    const initialDelay = `${0}s`;
    ...
    useEffect(() => {
        if (isVisible) {
            ...
            const totalTime = 600  // 600ms + (index * 100ms)
    ...
    }, [isVisible]); // Se ejecuta solo cuando hasBeenVisible cambia o el índice cambia
    ...
    return (
        ...
        >
            ...
            <h2 className='container-category-icons-title'>{data.title} </h2>
